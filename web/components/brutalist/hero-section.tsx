  ...
  return (
    <section className="relative flex w-full flex-1 flex-col justify-center px-5 py-3 sm:px-10 lg:px-20">
      <div className="mx-auto flex w-full max-w-4xl flex-col items-center text-center">
        ...
        >
          YOUR. <span className="text-[#ea580c]">REPO.</span>
        </motion.h1>
        ...
        >
          Free MongoDB-like database on a private GitHub repo. No servers.
          Studio and SDK ship on npm — this site is the story.
        </motion.p>
        ...
        >
          <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
            ...
            >
              ...
              <span className="px-4 py-2 sm:px-5 sm:py-2.5">Run Studio</span>
            </a>
          </motion.div>
          <a
            href="#product"
