  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        <ScrambleNumber target="$0" label="Hosted DB bill" delay={500} />
        <ScrambleNumber target="1" label="Private GitHub repo" delay={800} />
        <ScrambleNumber target="2" label="npm packages" delay={1100} />
        <ScrambleNumber target="0" label="Servers you run" delay={1400} />
      </div>
    </div>
  );
}
