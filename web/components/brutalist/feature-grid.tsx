...
import { TerminalCard } from "@/components/brutalist/bento/terminal-card";
import { DitherCard } from "@/components/brutalist/bento/dither-card";
import { MetricsCard } from "@/components/brutalist/bento/metrics-card";
import { StatusCard } from "@/components/brutalist/bento/status-card";
...
export function FeatureGrid() {
  return (
    <section id="product" className="w-full px-6 py-20 lg:px-12 scroll-mt-24">
      <motion.div
